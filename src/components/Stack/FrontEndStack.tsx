...
const frontEndItems: StackItem[] = [
  { src: "/assets/Stack/html-5.svg", alt: "HTML", label: "HTML" },
  {
    ...
    srcLight: "./assets/Stack/css-3.svg",
    srcDark: "./assets/Stack/css-3.svg",
    alt: "CSS",
    label: "CSS",
  },
  {
    src: "./assets/Stack/tailwindcss-icon.svg",
    srcLight: "./assets/Stack/tailwindcss-icon.svg",
    srcDark: "./assets/Stack/tailwindcss-icon.svg",
    alt: "Tailwind",
    label: "Tailwind",
  },
  {
    src: "./assets/Stack/javascript.svg",
    srcLight: "./assets/Stack/javascript.svg",
    srcDark: "./assets/Stack/javascript.svg",
    alt: "JavaScript",
    label: "JavaScript",
  },
  {
    src: "./assets/Stack/react.svg",
    srcLight: "./assets/Stack/react.svg",
    srcDark: "./assets/Stack/react.svg",
    alt: "React",
    label: "React",
  },
  {
    src: "./assets/Stack/nextjs.svg",
    srcLight: "./assets/Stack/nextjs.svg",
  ...
  },
  {
    ...
    srcLight: "./assets/Stack/typescript-icon.svg",
    srcDark: "./assets/Stack/typescript-icon.svg",
    alt: "TypeScript",
    label: "TypeScript",
  },
];
